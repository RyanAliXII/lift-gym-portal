...
func adminRoutes (router  * echo.Group){
	...
	router.PATCH("/clients/:id/verification", clientHandler.VerifyClient, middlewares.ValidatePermissions("Client.Edit"))
	router.PATCH("/clients/:id/unverification", clientHandler.RemoveVerification, middlewares.ValidatePermissions("Client.Edit"))
	...
	router.PUT("/general/inventory/:id", generalInventory.UpdateItem)
	router.DELETE("/general/inventory/:id", generalInventory.DeleteItem)
}	
...
func coachRoutes(router * echo.Group) {
	...
	router.PUT("/schedules/:id", coachSchedHandler.UpdateSchedule)
	router.DELETE("/schedules/:id", coachSchedHandler.DeleteSchedule)
}